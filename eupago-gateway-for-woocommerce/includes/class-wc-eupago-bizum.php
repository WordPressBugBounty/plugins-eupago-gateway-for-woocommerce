...
if (!class_exists('WC_Eupago_Bizum')) {
    ...
    class WC_Eupago_Bizum extends WC_Payment_Gateway {
        ...
        public function init_form_fields() {
            ...
            $payment_on_hold = __('SMS confirmation of payment details:', 'eupago-gateway-for-woocommerce');
            ...
            if ($admin_language === 'pt_PT' || $admin_language === 'pt_BR') {
                ...
                $payment_on_hold = esc_html__('Confirmación SMS de los detalles de Pago:', 'eupago-gateway-for-woocommerce');
        ...
        public function process_payment($order_id) {
            ...
            // Mark as on-hold
            $order->update_status('pending', __('Awaiting Bizum payment.', 'eupago-gateway-for-woocommerce'));
