...
if (!class_exists('WC_Eupago_Bizum')) {
    ...
    class WC_Eupago_Bizum extends WC_Payment_Gateway {
        ...
        public function init_form_fields() {
            ...
            $orders_description = __('Activate only for orders over X € (exclusive). Leave blank (or zero) to allow any order value. Eupago supports Bizum payments for transactions ranging from €0.50 to €2,000. However, the maximum limit may vary depending on the customer\'s bank, with some restricting payments to €1,000.', 'eupago-gateway-for-woocommerce');
            $orders_below = __('Only for orders below', 'eupago-gateway-for-woocommerce');
            $orders_below_description = __('Activate only for orders over X € (exclusive). Leave blank (or zero) to allow any order value. Eupago supports Bizum payments for transactions ranging from €0.50 to €2,000. However, the maximum limit may vary depending on the customer\'s bank, with some restricting payments to €1,000.', 'eupago-gateway-for-woocommerce');
            ...
            $enable_bizum = __('Enable Bizum', 'eupago-gateway-for-woocommerce');
            ...
            if ($admin_language === 'pt_PT' || $admin_language === 'pt_BR') {
                ...
                $enable_bizum = __('Ativar Bizum', 'eupago-gateway-for-woocommerce');
                $bizum = __('Bizum', 'eupago-gateway-for-woocommerce');
                ...
                $orders_description = __('Ativar apenas para encomendas acima de X € (exclusivo). Deixe em branco (ou zero) para permitir qualquer valor de encomenda. A Eupago suporta pagamentos via Bizum para transações entre 0,50 € e 2.000 €. No entanto, o limite máximo pode variar conforme o banco do cliente, sendo que alguns permitem apenas pagamentos de até 1.000 €.', 'eupago-gateway-for-woocommerce');
                $orders_below = __('Apenas para pedidos abaixo de', 'eupago-gateway-for-woocommerce');
                $orders_below_description = __('Ativar apenas para encomendas acima de X € (exclusivo). Deixe em branco (ou zero) para permitir qualquer valor de encomenda.A Eupago suporta pagamentos via Bizum para transações entre 0,50 € e 2.000 €. No entanto, o limite máximo pode variar conforme o banco do cliente, sendo que alguns permitem apenas pagamentos de até 1.000 €.', 'eupago-gateway-for-woocommerce');
                ...
                $title_bizum = __('Título', 'eupago-gateway-for-woocommerce');
                $enable_bizum = __('Activar Bizum', 'eupago-gateway-for-woocommerce');
                $bizum = __('Bizum', 'eupago-gateway-for-woocommerce');
                ...
                $orders_description = __('Activar sólo para pedidos superiores a X € (exclusivo). Déjelo en blanco (o cero) para permitir cualquier valor de pedido. Eupago admite pagos con Bizum en un rango de 0,50 € a 2.000 € por transacción. Sin embargo, el importe máximo puede variar según el banco del cliente, ya que algunos solo permiten pagos de hasta 1.000 €.', 'eupago-gateway-for-woocommerce');
                $orders_below = __('Solo para pedidos inferiores a', 'eupago-gateway-for-woocommerce');
                $orders_below_description = __('Activar sólo para pedidos superiores a X € (exclusivo). Déjelo en blanco (o cero) para permitir cualquier valor de pedido. Eupago admite pagos con Bizum en un rango de 0,50 € a 2.000 € por transacción. Sin embargo, el importe máximo puede variar según el banco del cliente, ya que algunos solo permiten pagos de hasta 1.000 €.', 'eupago-gateway-for-woocommerce');
